...
cd HP-REMIX/properties
cp ASCII-Shadow.flf ${PREFIX}/share/figlet

# change dir to home/HP-REMIX
cd $HOME
cd HP-REMIX
...
echo -e "\e[31m[\e[32m14\e[31m]\e[33m Best-of-HP-REMIX\e[m "
...
echo "figlet -f wetletter '                     $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "echo" > h-ban.txt
echo "figlet -f Bloody '      $varbanner' |lolcat -t " >> h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f small '                            $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f big '                          $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f starwars '   $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f smslant '                          $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f standard '                          $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f slant '            $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f Speed '         $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f red_phoenix '    $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f Soft '     $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "echo" > h-ban.txt
echo "figlet -f Roman '  $varbanner' |lolcat " >> h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "figlet -f Poison '     $varbanner' |lolcat " > h-ban.txt
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
echo "echo" > h-ban.txt
echo "figlet -f ASCII-Shadow '     $varbanner' |lolcat -t " >> h-ban.txt 
echo
echo "[*] Applying HP-REMIX Banner " |lolcat -t
sleep 2
echo
...
cat "h-ban.txt" >> /data/data/com.termux/files/usr/etc/bash.bashrc
